        ...
        return [
            {
                Header: '',
                id: 'gravatar',
                accessor: function (d) { return d.companyEmail; },
                width: 50,
                resizable: false,
                sortable: false,
                Cell: function (row) {
            ...
            },
            {
                ...
                Cell: function (row) {
                    ...
                    var isActive = row.value.isActive;
                    if (!employeeId) {
                        return '';
                    }
                    return (React.createElement(ActionsMenu, { history: _this.props.history, location: _this.props.location, match: _this.props.match, employeeId: employeeId, isActive: isActive, actions: _this.props.actions }));
                },
            },
        ];
    };
